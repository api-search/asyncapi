# asyncapi.apis.io — AsyncAPI Event-Driven Specs

[**asyncapi.apis.io**](https://asyncapi.apis.io) indexes [AsyncAPI](https://www.asyncapi.com/) specifications — event-driven APIs, webhooks, message queues, and streaming surfaces — across the network. Each spec describes the channels, events, and message schemas a consumer needs to subscribe to a webhook, consume from a queue, or process a stream.

**Live site:** [https://asyncapi.apis.io](https://asyncapi.apis.io)

## What's in this repo

- **`_asyncapis/`** — one Markdown file per AsyncAPI spec, organized by provider. Front matter carries channel descriptions, operation IDs, and links back to the provider profile.
